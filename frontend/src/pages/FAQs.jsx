          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                If youre not satisfied with your purchase, we accept returns
                ...
                brief explanation of why youre returning the item.
              </p>
            </div>
          )}
        </div>
          ...
          {activeTab === 5 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                youve ordered, you can return them for a refund within 30 days
                of delivery.
              </p>
            </div>
          )}
